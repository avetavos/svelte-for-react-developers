...
- React ส่ง **runtime** ไปยังทุก browser เพื่อ diff และ reconcile Svelte **compile ออกไป** — output คือโค้ด DOM manipulation ธรรมดา ไม่มี framework ใน bundle
...
export const quizMentalModelIndex = [
  ...
  },
  {
    ...
    options: [
      ...
      'มอบหมาย reconciliation ให้กับ browser',
    ],
    answer: 1,
  },
  {
