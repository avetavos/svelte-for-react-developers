...
export const spaStructureDiagram = `flowchart TB
  root(["project root"])
  root --> src["src/"]
...
<Mermaid code={spaStructureDiagram} title="Vite + Svelte SPA project structure" />

**SvelteKit** (เทียบเท่ากับ Next.js):

export const kitStructureDiagram = `flowchart TB
  root(["project root"])
  root --> src["src/"]
...
<Mermaid code={kitStructureDiagram} title="SvelteKit project structure" />
