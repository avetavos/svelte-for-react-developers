...
- **Runtime model** — React ส่ง JavaScript runtime library ที่รันใน browser ของทุกคน Svelte compile component เป็น vanilla JS ตอน build time ไม่มี framework code ถูกส่งไป
